function handleFormSubmit(event) {
    ...
    alert('Form submitted!'); // You can replace this with your desired functionality
}
...
function toggleMenu() {
  ...
  document.addEventListener("click", (e) => {
    // Assuming you have a button with class 'cdx-text-input__input'
    let button = e.target.closest(".btn");

    if (button) {
        // Redirect to the 'sam.html' page
